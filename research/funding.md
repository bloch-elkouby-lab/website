...
{% include card.html
   ...
   description="**Title**: Enhancing Suicide Risk Assessment and Prevention among Diverse Adolescents Using Virtual Human Interactions<br>**Amount**: $90k <br>**Grant Number**:YIG-0-023-20<br>**Role**: PI<br>**PI**: Igor Galynker, M.D., Ph.D.<br>**Awarded**: October 2021<br>**Initiated**: April 2022<br>[Link to grant website](https://afsp.org/grant/enhancing-suicide-risk-assessment-and-prevention-among-diverse-adolescents-using)"
   image="/images/Logo afsp.png"
   style="featured"
%}
